const {
  ...
  module.exports = {
    ...
    category: "Memer",
    permissions: [],
    description: "Generates a customised note image",
    usage: "note <text>",
    async execute (message, args, cmd, client, Discord, profileData) {
      ...
      memer.note(text).then(image => {
        //make an attachment
        let attachment = new MessageAttachment(image, "note.png");
        //delete old message
        tempmsg.delete();
        //send new Message
        message.channel.send(tempmsg.embeds[0]
          .setAuthor(`NOTED ${message.author.tag}`, message.author.displayAvatarURL())
